...
And then: 
- calculate the projected inventories and coverages
- analyze those values vs those defined targets


First, let's add some parameters to our initial database.

### Define min & max coverages
...
Let's add a few parameters to the initial database "my_demand_and_suppply"
